...
export default {
  forbidden: [
    ...
    {
      name: "measurement-must-not-know-assist",
      comment:
        "An LLM in the measurement path makes a failing run unreproducible " +
        "(R-10, PRD out of scope). `assist/` talks to `claude -p` AFTER " +
        "judgement — explain a brief, draft a ticket. journeys/, run/, geo/, " +
        "findings/, confidence/, browser/, watch/ and evidence/ must not " +
